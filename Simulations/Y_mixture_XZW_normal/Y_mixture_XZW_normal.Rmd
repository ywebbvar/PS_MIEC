---
title: "Results from Y as a mixture and (X,Z,W) as Multivariate Normal"
output:
  html_document:
    toc: true
    toc_depth: 2
...
setwd("C:/Users/Yenny/Dropbox/2012 Research/Causal_Research/Code/DavidCode/Simulation/Confidence intervals/Different Distributions/Y_mixture_XZW_normal")
...
We also use the measurement error model as $f(W \mid T,X,Z) \thicksim N(\beta_0 + \beta_1 X, \sigma^2)$.
...
##  This code was based on 'Y_mixture_XWZ_normal.R', which 
##  was purled from Y_misture_XWZ_normal.Rmd, 
...
save(results,file=paste("Simulation_Y_mixture_XZW_normal_", i, "-", format(Sys.time(), "%Y%m%d-%H%M"),".Rdata", sep=""))
```
