...
output:
  html_document:
    ...
    toc_depth: 2
---
These are results that different sample sizes for the main and calibration samples. They also include a simpler imputation method, in which a random error is sampled from a $N(0,\sigma^2)$, where $\sigma^2$ is the variance of the error in $W$. This method performs similar to the uncongenial method, and both of these perform worse than using a naive approach.
...
setwd("~/GitHub/PS_MIEC/Simulations/Sample_sizes/Cluster")
...
bigresults[["n_main_m"]][["sigma2_xs"]][["n_calib_s"]]<-results[["n_main_m"]][["sigma2_xs"]][["n_calib_s"]]

bigresults[["n_main_m"]][["sigma2_s"]][["n_calib_s"]] <- results[["n_main_m"]][["sigma2_s"]][["n_calib_s"]]

bigresults[["n_main_m"]][["sigma2_m"]][["n_calib_s"]] <- results[["n_main_m"]][["sigma2_m"]][["n_calib_s"]]

bigresults[["n_main_m"]][["sigma2_l"]][["n_calib_s"]] <- results[["n_main_m"]][["sigma2_l"]][["n_calib_s"]]


bigresults[["n_main_m"]][["sigma2_xs"]][["n_calib_m"]]<-results[["n_main_m"]][["sigma2_xs"]][["n_calib_m"]]

bigresults[["n_main_m"]][["sigma2_s"]][["n_calib_m"]] <- results[["n_main_m"]][["sigma2_s"]][["n_calib_m"]]

bigresults[["n_main_m"]][["sigma2_m"]][["n_calib_m"]] <- results[["n_main_m"]][["sigma2_m"]][["n_calib_m"]]

bigresults[["n_main_m"]][["sigma2_l"]][["n_calib_m"]] <- results[["n_main_m"]][["sigma2_l"]][["n_calib_m"]]


bigresults[["n_main_m"]][["sigma2_xs"]][["n_calib_l"]]<-results[["n_main_m"]][["sigma2_xs"]][["n_calib_l"]]

bigresults[["n_main_m"]][["sigma2_s"]][["n_calib_l"]] <- results[["n_main_m"]][["sigma2_s"]][["n_calib_l"]]

bigresults[["n_main_m"]][["sigma2_m"]][["n_calib_l"]] <- results[["n_main_m"]][["sigma2_m"]][["n_calib_l"]]

bigresults[["n_main_m"]][["sigma2_l"]][["n_calib_l"]] <- results[["n_main_m"]][["sigma2_l"]][["n_calib_l"]]




bigresults[["n_main_l"]][["sigma2_xs"]][["n_calib_s"]]<-results[["n_main_l"]][["sigma2_xs"]][["n_calib_s"]]

bigresults[["n_main_l"]][["sigma2_s"]][["n_calib_s"]] <- results[["n_main_l"]][["sigma2_s"]][["n_calib_s"]]

bigresults[["n_main_l"]][["sigma2_m"]][["n_calib_s"]] <- results[["n_main_l"]][["sigma2_m"]][["n_calib_s"]] 

bigresults[["n_main_l"]][["sigma2_l"]][["n_calib_s"]] <- results[["n_main_l"]][["sigma2_l"]][["n_calib_s"]]


bigresults[["n_main_l"]][["sigma2_xs"]][["n_calib_m"]]<-results[["n_main_l"]][["sigma2_xs"]][["n_calib_m"]]

bigresults[["n_main_l"]][["sigma2_s"]][["n_calib_m"]] <- results[["n_main_l"]][["sigma2_s"]][["n_calib_m"]]

bigresults[["n_main_l"]][["sigma2_m"]][["n_calib_m"]] <- results[["n_main_l"]][["sigma2_m"]][["n_calib_m"]] 

bigresults[["n_main_l"]][["sigma2_l"]][["n_calib_m"]] <- results[["n_main_l"]][["sigma2_l"]][["n_calib_m"]]


bigresults[["n_main_l"]][["sigma2_xs"]][["n_calib_l"]]<-results[["n_main_l"]][["sigma2_xs"]][["n_calib_l"]]

bigresults[["n_main_l"]][["sigma2_s"]][["n_calib_l"]] <- results[["n_main_l"]][["sigma2_s"]][["n_calib_l"]]

bigresults[["n_main_l"]][["sigma2_m"]][["n_calib_l"]] <- results[["n_main_l"]][["sigma2_m"]][["n_calib_l"]] 

bigresults[["n_main_l"]][["sigma2_l"]][["n_calib_l"]] <- results[["n_main_l"]][["sigma2_l"]][["n_calib_l"]]

for(i in archive_names[-1]) {
  load(i)
  
bigresults[["n_main_m"]][["sigma2_xs"]][["n_calib_s"]] <- cbind(bigresults[["n_main_m"]][["sigma2_xs"]][["n_calib_s"]], results[["n_main_m"]][["sigma2_xs"]][["n_calib_s"]])

  bigresults[["n_main_m"]][["sigma2_s"]][["n_calib_s"]] <- cbind(bigresults[["n_main_m"]][["sigma2_s"]][["n_calib_s"]], results[["n_main_m"]][["sigma2_s"]][["n_calib_s"]])

bigresults[["n_main_m"]][["sigma2_m"]][["n_calib_s"]] <- cbind(bigresults[["n_main_m"]][["sigma2_m"]][["n_calib_s"]], results[["n_main_m"]][["sigma2_m"]][["n_calib_s"]])

bigresults[["n_main_m"]][["sigma2_l"]][["n_calib_s"]] <- cbind(bigresults[["n_main_m"]][["sigma2_l"]][["n_calib_s"]], results[["n_main_m"]][["sigma2_l"]][["n_calib_s"]])

  
bigresults[["n_main_m"]][["sigma2_xs"]][["n_calib_m"]] <- cbind(bigresults[["n_main_m"]][["sigma2_xs"]][["n_calib_m"]], results[["n_main_m"]][["sigma2_xs"]][["n_calib_m"]])

  bigresults[["n_main_m"]][["sigma2_s"]][["n_calib_m"]] <- cbind(bigresults[["n_main_m"]][["sigma2_s"]][["n_calib_m"]], results[["n_main_m"]][["sigma2_s"]][["n_calib_m"]])

bigresults[["n_main_m"]][["sigma2_m"]][["n_calib_m"]] <- cbind(bigresults[["n_main_m"]][["sigma2_m"]][["n_calib_m"]], results[["n_main_m"]][["sigma2_m"]][["n_calib_m"]])

bigresults[["n_main_m"]][["sigma2_l"]][["n_calib_m"]] <- cbind(bigresults[["n_main_m"]][["sigma2_l"]][["n_calib_m"]], results[["n_main_m"]][["sigma2_l"]][["n_calib_m"]])
  
  
bigresults[["n_main_m"]][["sigma2_xs"]][["n_calib_l"]] <- cbind(bigresults[["n_main_m"]][["sigma2_xs"]][["n_calib_l"]], results[["n_main_m"]][["sigma2_xs"]][["n_calib_l"]])

bigresults[["n_main_m"]][["sigma2_s"]][["n_calib_l"]] <- cbind(bigresults[["n_main_m"]][["sigma2_s"]][["n_calib_l"]], results[["n_main_m"]][["sigma2_s"]][["n_calib_l"]])

bigresults[["n_main_m"]][["sigma2_m"]][["n_calib_l"]] <- cbind(bigresults[["n_main_m"]][["sigma2_m"]][["n_calib_l"]], results[["n_main_m"]][["sigma2_m"]][["n_calib_l"]])

bigresults[["n_main_m"]][["sigma2_l"]][["n_calib_l"]] <- cbind(bigresults[["n_main_m"]][["sigma2_l"]][["n_calib_l"]], results[["n_main_m"]][["sigma2_l"]][["n_calib_l"]])




bigresults[["n_main_l"]][["sigma2_xs"]][["n_calib_s"]] <- cbind(bigresults[["n_main_l"]][["sigma2_xs"]][["n_calib_s"]], results[["n_main_l"]][["sigma2_xs"]][["n_calib_s"]])

bigresults[["n_main_l"]][["sigma2_s"]][["n_calib_s"]] <- cbind(bigresults[["n_main_l"]][["sigma2_s"]][["n_calib_s"]], results[["n_main_l"]][["sigma2_s"]][["n_calib_s"]])

bigresults[["n_main_l"]][["sigma2_m"]][["n_calib_s"]] <- cbind(bigresults[["n_main_l"]][["sigma2_m"]][["n_calib_s"]], results[["n_main_l"]][["sigma2_m"]][["n_calib_s"]])

bigresults[["n_main_l"]][["sigma2_l"]][["n_calib_s"]] <- cbind(bigresults[["n_main_l"]][["sigma2_l"]][["n_calib_s"]], results[["n_main_l"]][["sigma2_l"]][["n_calib_s"]])

  
bigresults[["n_main_l"]][["sigma2_xs"]][["n_calib_m"]] <- cbind(bigresults[["n_main_l"]][["sigma2_xs"]][["n_calib_m"]], results[["n_main_l"]][["sigma2_xs"]][["n_calib_m"]])

bigresults[["n_main_l"]][["sigma2_s"]][["n_calib_m"]] <- cbind(bigresults[["n_main_l"]][["sigma2_s"]][["n_calib_m"]], results[["n_main_l"]][["sigma2_s"]][["n_calib_m"]])

bigresults[["n_main_l"]][["sigma2_m"]][["n_calib_m"]] <- cbind(bigresults[["n_main_l"]][["sigma2_m"]][["n_calib_m"]], results[["n_main_l"]][["sigma2_m"]][["n_calib_m"]])

bigresults[["n_main_l"]][["sigma2_l"]][["n_calib_m"]] <- cbind(bigresults[["n_main_l"]][["sigma2_l"]][["n_calib_m"]], results[["n_main_l"]][["sigma2_l"]][["n_calib_m"]])
  

bigresults[["n_main_l"]][["sigma2_xs"]][["n_calib_l"]] <- cbind(bigresults[["n_main_l"]][["sigma2_xs"]][["n_calib_l"]], results[["n_main_l"]][["sigma2_xs"]][["n_calib_l"]])

bigresults[["n_main_l"]][["sigma2_s"]][["n_calib_l"]] <- cbind(bigresults[["n_main_l"]][["sigma2_s"]][["n_calib_l"]], results[["n_main_l"]][["sigma2_s"]][["n_calib_l"]])

bigresults[["n_main_l"]][["sigma2_m"]][["n_calib_l"]] <- cbind(bigresults[["n_main_l"]][["sigma2_m"]][["n_calib_l"]], results[["n_main_l"]][["sigma2_m"]][["n_calib_l"]])

bigresults[["n_main_l"]][["sigma2_l"]][["n_calib_l"]] <- cbind(bigresults[["n_main_l"]][["sigma2_l"]][["n_calib_l"]], results[["n_main_l"]][["sigma2_l"]][["n_calib_l"]])
  
}

#Number of simulations used
N_sim <- ncol(bigresults[["n_main_l"]][["sigma2_l"]][["n_calib_l"]])
```
...
We use $$f(X,Z) \thicksim N_2 \Bigl(\bigl(\begin{smallmatrix} 0 \\ 0 \end{smallmatrix} \bigr), \bigl(\begin{smallmatrix} 1 && \n_calib \\ \n_calib && 1\end{smallmatrix}\bigl)\Bigl).$$
...
|  |small $\gamma_X$ |`r n_main_m`|  |$Y$   |$\Delta$ | `r Delta`
|  |large $\gamma_X$ |`r n_main_l`|  |      |$\delta_X$| `r delta_X`
$(X,Z)$| low $\n_calib$ |`r n_calib_s` |  |        |$\delta_Z$| `r delta_Z` 
|  | medium $\n_calib$|  `r n_calib_m` |      |        |$\tau^2$  | `r tau2`
| | high $\n_calib$|  `r n_calib_l` |      |        | | 
...
big_table <- bias_RMSE_cov(bigresults[["n_main_m"]][["sigma2_l"]][["n_calib_s"]], Delta)

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_m"]][["sigma2_m"]][["n_calib_s"]], Delta))

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_m"]][["sigma2_s"]][["n_calib_s"]], Delta))

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_m"]][["sigma2_xs"]][["n_calib_s"]], Delta))


big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_m"]][["sigma2_l"]][["n_calib_m"]], Delta))

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_m"]][["sigma2_m"]][["n_calib_m"]], Delta))

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_m"]][["sigma2_s"]][["n_calib_m"]], Delta))

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_m"]][["sigma2_xs"]][["n_calib_m"]], Delta))


big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_m"]][["sigma2_l"]][["n_calib_l"]], Delta))

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_m"]][["sigma2_m"]][["n_calib_l"]], Delta))

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_m"]][["sigma2_s"]][["n_calib_l"]], Delta))

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_m"]][["sigma2_xs"]][["n_calib_l"]], Delta))



big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_l"]][["sigma2_l"]][["n_calib_s"]], Delta))

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_l"]][["sigma2_m"]][["n_calib_s"]], Delta))

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_l"]][["sigma2_s"]][["n_calib_s"]], Delta))

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_l"]][["sigma2_xs"]][["n_calib_s"]], Delta))


big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_l"]][["sigma2_l"]][["n_calib_m"]], Delta))

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_l"]][["sigma2_m"]][["n_calib_m"]], Delta))

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_l"]][["sigma2_s"]][["n_calib_m"]], Delta))

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_l"]][["sigma2_xs"]][["n_calib_m"]], Delta))


big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_l"]][["sigma2_l"]][["n_calib_l"]], Delta))

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_l"]][["sigma2_m"]][["n_calib_l"]], Delta))

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_l"]][["sigma2_s"]][["n_calib_l"]], Delta))

big_table <- cbind(big_table, bias_RMSE_cov(bigresults[["n_main_l"]][["sigma2_xs"]][["n_calib_l"]], Delta))

big_table <- t(big_table)

params_cols <- data.frame(n_main = gl(n=2,k=12,labels=c(2500,10000)), reliability = rep(rels,6), n_calib = rep(c(100,500,1000), 2, each=4))
...
colnames(print_table)[1:4] <- c("$n_main$", "Reliability", "$n_calib$", ".")
```

```{r print_table, results='asis',eval=TRUE, echo=FALSE}
# Big table with all results
print(xtable(print_table), type = 'html', html.table.attributes = '', include.rownames=FALSE)
```

```{r noModelPS_Bias_RMSE, fig.height=3.5,fig.width=10, dpi=300, fig.path='figure/', eval=FALSE, echo=FALSE}
...
names(results_long)[2:4] <- c("n_main", "reliability","n_calib")
results_long$method <- factor(results_long$method)
levels(results_long$method) <- c("Simple MI", "MI-EC (Y_obs,Z)", "Uncongenial MI-EC","MI-EC (T,Z)","Congenial MI-EC","Naive (W)","Truth (X)")
results_long$method_relev <- factor(results_long$method, levels=c("Truth (X)","Naive (W)", "Simple MI", "Congenial MI-EC", "MI-EC (Y_obs,Z)", "MI-EC (T,Z)", "Uncongenial MI-EC"))


results_long$n_main_F <- factor(results_long$n_main, levels = c(2500,10000),labels = paste("n_main", c(2500,10000)))
results_long$n_calib_F    <- factor(results_long$n_calib, levels = c(100,500,1000), labels = paste("n_calib", c(100,500,1000)))
...
# Scatterplot of reliability vs. average bias for each combination of n_main and n_calib
# in each facet, method is represented by shape and color
p <- qplot(reliability, abs(average), data=subset(results_long, metric != "Cov"), linetype=method_relev, color=method_relev, facets=metric~n_main_F+n_calib_F, size=I(1.2), geom=c("line"), xlab="Reliability", ylab="") 
p + scale_linetype_manual(values=c("Uncongenial MI-EC"="longdash","Congenial MI-EC"= "solid", "Naive (W)"="dotdash", "Truth (X)"="dotted", "Simple MI"="twodash")) + scale_colour_grey() + theme_bw() 
```

```{r noModelPS_Noncov_re, fig.height=2.5,fig.width=10, dpi=300, fig.path='figure/', eval=FALSE, echo=FALSE}
# B&W figure Coverage
full_cols <- all_cols
full_cols[seq(2,nrow(all_cols),by=3),] <- as.numeric(as.matrix(params_cols))
full_cols[seq(3,nrow(all_cols),by=3),] <- as.numeric(as.matrix(params_cols))
...
# Scatterplot of reliability vs. non coverage for each combination of n_main and n_calib
# in each facet, method is represented by shape and color
p <- qplot(reliability, average, data=subset(results_long, metric == "95% CI Coverage"), linetype=method_relev, color=method_relev,facets=metric~n_main_F+n_calib_F, size=I(1.2),  geom=c("line"), xlab="Reliability", ylab="") 
p + scale_linetype_manual(values=c("Uncongenial MI-EC"="longdash","Congenial MI-EC"= "solid", "Naive (W)"="dotdash", "Truth (X)"="dotted", "Simple MI"="twodash")) + scale_colour_grey() + theme_bw() 
```

```{r noModelPS_Bias_RMSE_color_paper, fig.height=3.5,fig.width=10, dpi=300, fig.path='figure/', eval=FALSE,echo=FALSE}
full_cols <- all_cols
full_cols[seq(2,nrow(all_cols),by=3),] <- as.numeric(as.matrix(params_cols))
full_cols[seq(3,nrow(all_cols),by=3),] <- as.numeric(as.matrix(params_cols))
...
# in each facet, method is represented by shape and color
p <- qplot(reliability, abs(average), data=subset(results_long, metric != "Cov"), linetype=method_relev, color=method_relev, facets=metric~n_main_F+n_calib_F, size=I(1.2), geom=c("line"), xlab="Reliability", ylab="") 
p + scale_linetype_manual(values=c("Uncongenial MI-EC"="longdash","Congenial MI-EC"= "solid", "Naive (W)"="dotdash", "Truth (X)"="dotted", "Simple MI"="twodash")) 
```


```{r noModelPS_Noncov_re_color_paper, fig.height=2.5,fig.width=10, dpi=300, fig.path='figure/', eval=FALSE, echo=FALSE}
full_cols <- all_cols
full_cols[seq(2,nrow(all_cols),by=3),] <- as.numeric(as.matrix(params_cols))
full_cols[seq(3,nrow(all_cols),by=3),] <- as.numeric(as.matrix(params_cols))
