---
title: "Results from Y as Bernoulli and (X,Z,W) as a truncated mixture"
output:
  html_document:
    toc: true
    toc_depth: 2
...
We use the measurement error model as $f(W \mid T,X,Z) \thicksim N(\beta_0 + \beta_1 X, \sigma^2)$, and a distribution of the potential outcomes as $f(Y(T) \mid T,X,Z) \thicksim Bernoulli(expit(\Delta T + \delta_X X + \delta_Z Z))$.
