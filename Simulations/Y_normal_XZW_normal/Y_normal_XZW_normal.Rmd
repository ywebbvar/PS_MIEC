...
```{r noModelPS_Bias_RMSE, fig.height=5.5,fig.width=13, dpi=300, fig.path='figure/', eval=TRUE, echo=FALSE}
...
```{r noModelPS_Noncov_re, fig.height=3.5,fig.width=13, dpi=300, fig.path='figure/', eval=TRUE, echo=FALSE}
# B&W figure Coverage
full_cols <- all_cols
full_cols[seq(2,nrow(all_cols),by=3),] <- as.numeric(as.matrix(params_cols))
full_cols[seq(3,nrow(all_cols),by=3),] <- as.numeric(as.matrix(params_cols))
