---
title: "Results from Y as Normal and (X,Z,W) as a truncated mixture"
output:
  html_document:
    toc: true
    toc_depth: 2
...
setwd("C:/Users/Yenny/Dropbox/2012 Research/Causal_Research/Code/DavidCode/Simulation/Confidence intervals/Different Distributions/Y_normal_XZW_mixture")
...
save(results,file=paste("Simulation_Y_normal_XZW_mixture_", i, "-", format(Sys.time(), "%Y%m%d-%H%M"),".Rdata", sep=""))
```
